...
char *get_value_str(char *dest_str, void *data, size_t size, VALUE_Type_t value_type)
{
  ...
  switch(value_type)
  {
    ...
    case INT16:
      ...
      break;
    case INT32:
      snprintf(dest_str, size, "%d", *(signed int*)data);
    case INT64:
    ...
    case UINT16:
      ...
      break;
    case UINT32:
      snprintf(dest_str, size, "%u", *(unsigned int*)data);
      break;
    case UINT64:
...
/**
  ...
  ******************************************************************
  */
float common_get_float_data(const uint8_t *data, int start_index)
{
...
/**
  ...
  ******************************************************************
  */
uint16_t common_get_u16_data(const uint8_t *data, int start_index)
{
...
/**
  ...
  ******************************************************************
  */
uint32_t common_get_u32_data(const uint8_t *data, int start_index)
{
...
/**
  ...
  ******************************************************************
  */
uint32_t common_get_modbus_u32_data(const uint8_t *data, int start_index)
{
  static uint32_t result_u32 = 0;
  if(data == NULL)
  {
...
/**
  ...
  ******************************************************************
  */
uint16_t common_get_modbus_u16_data(const uint8_t *data, int start_index)
{
  static uint16_t result_u16 = 0;
  if(data == NULL)
  {
...
/**
  ...
  ******************************************************************
  */
float common_get_modbus_float_data(const uint8_t *data, int start_index)
{
  static float result_float = 0.0;
  if(data == NULL)
  {
