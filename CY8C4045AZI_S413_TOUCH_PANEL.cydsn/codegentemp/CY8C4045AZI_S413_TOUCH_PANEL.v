...
module CapSense_P4_v5_0_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("ab76ed17-818d-42e4-accb-378c61c0a89a/ea884bc0-86af-40f9-b67b-efbe1ecd0ccd"),
		  ...
		  .pa_out_clock_en(-1),
		  .pa_out_reset(-1),
		  .pin_aliases("BTN0_VOL_I_Rx0,BTN1_VOL_D_Rx0,BTN2_SET_MODE_Rx0"),
		  .pin_mode("AAA"),
		  .por_state(4),
		  .sio_group_cnt(0),
		  .sio_hyst(3'b1_1_1),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("027f727f-5397-423c-90e2-6f38557d3967"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("422229ca-4647-4302-8d0d-fdddb7776edd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("06e39753-a239-4940-a6a6-77066239ec92"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
